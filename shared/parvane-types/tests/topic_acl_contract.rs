...
const IDENTITY_BINDINGS: &[(&str, &str)] = &[
    ...
    ("IDENTITY_EMAIL_CONFIRM", IDENTITY_EMAIL_CONFIRM),
    ("IDENTITY_SERVER_INFO", IDENTITY_SERVER_INFO),
    ("IDENTITY_TELEGRAM_CONFIRM", IDENTITY_TELEGRAM_CONFIRM),
    ("IDENTITY_REGISTER_STATUS", IDENTITY_REGISTER_STATUS),
    ("IDENTITY_TWOFA", IDENTITY_TWOFA),
    ...
    ("IDENTITY_DEVICE_LIST", IDENTITY_DEVICE_LIST),
    ("IDENTITY_DEVICE_REVOKE", IDENTITY_DEVICE_REVOKE),
    ("IDENTITY_LINK_OFFER", IDENTITY_LINK_OFFER),
    ("IDENTITY_LINK_POLL", IDENTITY_LINK_POLL),
    ("IDENTITY_LINK_GRANT", IDENTITY_LINK_GRANT),
];
